...
namespace DungeonPlayer
{
    public class WorldEnvironment : MonoBehaviour
    {
        ...
        public int DungeonField { get; set; } // ƒVƒ“ƒOƒ‹ƒ_ƒ“ƒWƒ‡ƒ“‚ÌƒtƒB[ƒ‹ƒh‚ğ¦‚·’l
        ...
        public bool AlreadyMonsterQuestComplete { get; set; } // 1‰ñƒ‚ƒ“ƒXƒ^[“¢”°‚ÉƒNƒŠƒA‚µ‚½‚çA‚»‚Ì“ú‚Í˜A‘±‚Åo—ˆ‚È‚¢–‚Æ‚·‚éB
        ...
        public bool AvailableMonsterQuest { get; set; } // ƒ‚ƒ“ƒXƒ^[“¢”°i1F‰‚ß‚©‚çƒTƒ“ƒfƒB‚ğ’Ç‰Áj
        ...
        public bool Truth_CommunicationHanna0 { get; set; } // ‰‰ñƒŒƒxƒ‹ƒAƒbƒv‚Åh‰®‚ÉŒ¾‚Á‚½ê‡‚ÌSoul-Style
