...
{
    public partial class SingleDungeon : MotherForm
    {
        ...
        //    UpdateBattleCommandSetting(GroundOne.P1, ActionButton1, IsSorcery1);
        //    if (GroundOne.WE.AvailableSecondCharacter)
        //    {
        //        UpdateBattleCommandSetting(GroundOne.P2, ActionButton2, IsSorcery2);
        //    }
        //    if (GroundOne.WE.AvailableThirdCharacter)
        //    {
        //        UpdateBattleCommandSetting(GroundOne.P3, ActionButton3, IsSorcery3);
        //    }
        //}
        ...
        {
            // debug
            //if (GroundOne.P1 != null)
            //{
            //    this.debug1.text = GroundOne.P1.TotalStrength.ToString();
            //    this.debug2.text = GroundOne.P1.TotalAgility.ToString();
            //    this.debug3.text = GroundOne.P1.TotalIntelligence.ToString();
            //    this.debug4.text = GroundOne.P1.TotalStamina.ToString();
            //    this.debug5.text = GroundOne.P1.TotalMind.ToString();
            //    this.debug21.text = PrimaryLogic.PhysicalAttackValue(GroundOne.P1, PrimaryLogic.NeedType.Min, 1.0F, 0.0F, 0.0F, 0.0F, 1.0F, PrimaryLogic.SpellSkillType.Standard, false).ToString("F2");
            //    this.debug22.text = PrimaryLogic.PhysicalDefenseValue(GroundOne.P1, PrimaryLogic.NeedType.Min, false).ToString("F2");
            //    this.debug23.text = PrimaryLogic.MagicAttackValue(GroundOne.P1, PrimaryLogic.NeedType.Min, 1.0F, 0.0F, PrimaryLogic.SpellSkillType.Standard, false, false).ToString("F2");
            //    this.debug24.text = PrimaryLogic.MagicDefenseValue(GroundOne.P1, PrimaryLogic.NeedType.Min, false).ToString("F2");
            //    this.debug25.text = PrimaryLogic.BattleSpeedValue(GroundOne.P1, false).ToString("F2");
            //    this.debug26.text = PrimaryLogic.BattleResponseValue(GroundOne.P1, false).ToString("F2");
            //    this.debug27.text = PrimaryLogic.PotentialValue(GroundOne.P1, false).ToString("F2");
            //    this.debug31.text = GroundOne.P1.Target.FirstName;
            //    //this.debug41.text = GroundOne.P1.MaxLife.ToString();
            //    //this.debug42.text = GroundOne.P1.MaxMana.ToString();
            //    //this.debug43.text = GroundOne.P1.MaxInstantPoint.ToString();
            //    this.debug41.text = GroundOne.P1.CurrentLife.ToString();
            //    this.debug42.text = GroundOne.P1.CurrentMana.ToString();
            //    this.debug43.text = GroundOne.P1.CurrentSkillPoint.ToString();
            //    this.debug51.text = GroundOne.P1.Gold.ToString();
            //}
            //if (ec1 != null)
            //{
            ...
            for (int ii = 0; ii < keyCodeData1.Length; ii++)
            {
                ...
                {
                    ActionCommand(detectShift, GroundOne.P1, GroundOne.P1.BattleActionCommandList[ii]);
                }
            }
            ...
            for (int ii = 0; ii < keyCodeData2.Length; ii++)
            {
                ...
                {
                    ActionCommand(detectShift, GroundOne.P2, GroundOne.P2.BattleActionCommandList[ii]);
                }
            }
            ...
            for (int ii = 0; ii < keyCodeData3.Length; ii++)
            {
                ...
                {
                    ActionCommand(detectShift, GroundOne.P3, GroundOne.P3.BattleActionCommandList[ii]);
                }
            }
        ...
        private void UpdatePlayerDoStackInTheCommand(MainCharacter player)
        {
            ...
            if (player.FirstName == Database.DUEL_SELMOI_RO)
            {
                ...
                if (player.CurrentInstantPoint >= player.MaxInstantPoint && 50 < player.BattleBarPos && player.BattleBarPos < 100)
                {
                    if (existItem)
                    {
                        ...
                        player.StackActivePlayer = player;
                        player.StackTarget = GroundOne.P1;
            ...
            else if (player.FirstName == Database.ENEMY_BOSS_KARAMITUKU_FLANSIS)
            {
                if (player.CurrentInstantPoint >= player.MaxInstantPoint && 150 < player.BattleBarPos && player.BattleBarPos < 200)
                {
                    UseInstantPoint(player);
                    player.StackActivePlayer = ec1;
                    if (GroundOne.P1 != null && !GroundOne.P1.Dead) player.StackTarget = GroundOne.P1;
                    else if (GroundOne.P2 != null && !GroundOne.P2.Dead) player.StackTarget = GroundOne.P2;
            ...
            else if (player.FirstName == Database.DUEL_OL_LANDIS)
            {
                if (player.CurrentInstantPoint >= player.MaxInstantPoint)
                {
                    if ((GroundOne.P1.CurrentLife < 500) && (GroundOne.P1.CurrentParalyze <= 0) && (ec1.CurrentSkillPoint >= Database.SURPRISE_ATTACK_COST))
                    {
                        UseInstantPoint(player);
                        player.StackActivePlayer = ec1;
                        player.StackTarget = GroundOne.P1;
                    ...
                    {
                        if ((GroundOne.P1.CurrentBlackFire <= 0) && (ec1.CurrentMana >= Database.BLACK_FIRE_COST))
                        {
                            UseInstantPoint(player);
                            player.StackActivePlayer = ec1;
                            player.StackTarget = GroundOne.P1;
                        ...
                        else if ((GroundOne.P1.CurrentImmolate <= 0) && (ec1.CurrentMana >= Database.IMMOLATE_COST))
                        {
                            UseInstantPoint(player);
                            player.StackActivePlayer = ec1;
                            player.StackTarget = GroundOne.P1;
                ...
                // ちょっと強すぎるので、封印か。
                //    if ((GroundOne.P1.CurrentLife < GroundOne.P1.MaxLife / 2) && (ec1.CurrentSkillPoint >= Database.CRUSHING_BLOW_COST))
                //    {
                //        UseInstantPoint(player);
                //        player.StackActivePlayer = ec1;
                //        player.StackTarget = GroundOne.P1;
            ...
            else if (player.FirstName == Database.ENEMY_SHELL_SWORD_KNIGHT)
            {
                if (player.CurrentInstantPoint >= player.MaxInstantPoint)
                {
                    ...
                    else if (GroundOne.P3 != null && !GroundOne.P3.Dead) { player.StackTarget = GroundOne.P3; }
                    player.StackPlayerAction = MainCharacter.PlayerAction.SpecialSkill;
            ...
            else if (player.FirstName == Database.ENEMY_SEA_STAR_KNIGHT_AEGIRU)
            {
                if (player.CurrentInstantPoint >= player.MaxInstantPoint)
                {
                    ...
                    if (GroundOne.P2 != null && !GroundOne.P2.Dead) { player.StackTarget = GroundOne.P2; }
                    else if (GroundOne.P3 != null && !GroundOne.P3.Dead) { player.StackTarget = GroundOne.P3; }
                    else if (GroundOne.P1 != null && !GroundOne.P1.Dead) { player.StackTarget = GroundOne.P1; }
                    player.StackPlayerAction = MainCharacter.PlayerAction.SpecialSkill;
            ...
            else if (player.FirstName == Database.ENEMY_SEA_STAR_KNIGHT_AMARA)
            {
                if (player.CurrentInstantPoint >= player.MaxInstantPoint)
                {
                    ...
                    if (GroundOne.P3 != null && !GroundOne.P3.Dead) { player.StackTarget = GroundOne.P3; }
                    else if (GroundOne.P2 != null && !GroundOne.P2.Dead) { player.StackTarget = GroundOne.P2; }
                    else if (GroundOne.P1 != null && !GroundOne.P1.Dead) { player.StackTarget = GroundOne.P1; }
                    player.StackPlayerAction = MainCharacter.PlayerAction.SpecialSkill;
            ...
            else if (player.FirstName == Database.DUEL_PERMA_WARAMY)
            {
                if (player.CurrentInstantPoint >= player.MaxInstantPoint && player.BattleBarPos < 50)
                {
                    ...
                    else if (GroundOne.P1.CurrentEnrageBlast <= 0)
                    {
                        player.StackActivePlayer = ec1;
                        player.StackTarget = GroundOne.P1;
                        player.StackPlayerAction = MainCharacter.PlayerAction.UseSpell;
            ...
            else if (player.FirstName == Database.DUEL_KILT_JORJU)
            {
                if (player.CurrentInstantPoint >= player.MaxInstantPoint)
                {
                    if (GroundOne.P1.CurrentLife <= 1200)
                    {
            ...
            else if (player.FirstName == Database.VERZE_ARTIE)
            {
                if (player.CurrentInstantPoint >= player.MaxInstantPoint)
                {
                    ...
                    else if (GroundOne.P1.CurrentHolyBreaker > 0)
                    {
                        if (player.CurrentSkillPoint > Database.PSYCHIC_WAVE_COST)
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSkill, Database.PSYCHIC_WAVE);
                        }
                        else
                        {
                    ...
                    else if (player.CurrentGaleWind > 0)
                    {
                        ...
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSkill, Database.STRAIGHT_SMASH);
                        }
                        else
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSkill, Database.NEUTRAL_SMASH);
                        }
                    }
                    else if (player.CurrentCounterAttack <= 0 && player.CurrentDeflection <= 0)
                    {
                        ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSkill, Database.COUNTER_ATTACK);
                    }
            ...
            else if (player.FirstName == Database.DUEL_CALMANS_OHN)
            {
                if (player.CurrentInstantPoint >= player.MaxInstantPoint)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (GroundOne.P1.CurrentLife <= GroundOne.P1.MaxLife / 2)
                            {
                                UseInstantPoint(player);
                                player.StackActivePlayer = ec1;
                                player.StackTarget = ec1;
            ...
            else if (player.FirstName == Database.DUEL_SUN_YU)
            {
                if (player.CurrentInstantPoint >= player.MaxInstantPoint)
                {
                    if (GroundOne.P1.CurrentAetherDrive > 0)
                    {
                        ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSpell, Database.TRANQUILITY);
                    }
                    else if (GroundOne.P1.CurrentSaintPower > 0)
                    {
                        ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSpell, Database.DISPEL_MAGIC);
                    }
                }
            }
            #endregion
            ...
            else if (player.FirstName == Database.DUEL_SHUVALTZ_FLORE)
            {
                if (player.CurrentInstantPoint >= player.MaxInstantPoint)
                {
                    ...
                    {
                        if (50 < GroundOne.P1.BattleBarPos && GroundOne.P1.BattleBarPos < 75)
                        {
                            ((TruthEnemyCharacter)player).AI_TacticsNumber = 0;
                        }
                    }
            ...
            {
                if ((player.CurrentInstantPoint >= player.MaxInstantPoint) &&
                    (GroundOne.P1.CurrentInstantPoint < GroundOne.P1.MaxInstantPoint))
                {
                    if (((TruthEnemyCharacter)player).AI_TacticsNumber == 0)
                    {
                        if ((GroundOne.P1.CurrentFrozen <= 0) &&
                            (((TruthEnemyCharacter)player).DetectCannotBeFrozen == false))
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSpell, Database.CHILL_BURN);
                        }
                        ...
                        else if (GroundOne.P1.CurrentWordOfMalice <= 0)
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSpell, Database.WORD_OF_MALICE);
                        }
                        else if (GroundOne.P1.CurrentBlackFire <= 0)
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSpell, Database.BLACK_FIRE);
                        }
                        else
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSpell, Database.PIERCING_FLAME);
                        }
                        //((TruthEnemyCharacter)player).AI_TacticsNumber = 1;
                    }
                    //else if (((TruthEnemyCharacter)player).AI_TacticsNumber == 1)
            ...
            else if (player.FirstName == Database.DUEL_RVEL_ZELKIS)
            {
                if ((player.CurrentInstantPoint >= player.MaxInstantPoint))
                {
                    ...
                    else if (((TruthEnemyCharacter)player).AI_TacticsNumber == 2)
                    {
                        ...
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSkill, Database.CARNAGE_RUSH);
                        }
                        else
                        {
                            ExecActionMethod(player, player, MainCharacter.PlayerAction.UseSkill, Database.INNER_INSPIRATION);
            ...
            else if (player.FirstName == Database.DUEL_VAN_HEHGUSTEL)
            {
                if ((player.CurrentInstantPoint >= player.MaxInstantPoint))
                {
                    ...
                    {
                        if ((GroundOne.P1.CurrentLife < GroundOne.P1.MaxLife * 2 / 3) &&
                            (player.CurrentSkillPoint >= Database.SURPRISE_ATTACK_COST) &&
                            (GroundOne.P1.CurrentParalyze <= 0) &&
                            (((TruthEnemyCharacter)player).DetectCannotBeParalyze == false))
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSkill, Database.SURPRISE_ATTACK);
                        }
                        else
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSkill, Database.NEUTRAL_SMASH);
            ...
            else if (player.FirstName == Database.DUEL_OHRYU_GENMA)
            {
                if ((player.CurrentInstantPoint >= player.MaxInstantPoint))
                {
                    ...
                    {
                        ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSpell, Database.WORD_OF_POWER);
                    }
                }
            }
            #endregion
            ...
            {
                if ((player.CurrentInstantPoint >= player.MaxInstantPoint) &&
                    (GroundOne.P1.CurrentInstantPoint < 500) &&
                    (GroundOne.P1.CurrentMana > 0))
                {
            ...
            else if (player.FirstName == Database.ENEMY_LAST_RANA_AMILIA)
            {
                if (player.CurrentInstantPoint >= player.MaxInstantPoint)
                {
                    ...
                    else
                    {
                        ...
                        else if ((GroundOne.P1.CurrentImpulseHitValue < 3) && (player.CurrentSkillPoint >= Database.IMPULSE_HIT_COST))
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSkill, Database.IMPULSE_HIT);
                        }
                        else if ((GroundOne.P1.CurrentMana >= GroundOne.P1.MaxMana / 5) && (player.CurrentMana >= Database.DOOM_BLADE_COST))
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSpell, Database.DOOM_BLADE);
                        }
                        else
                        {
                            switch (AP.Math.RandomInteger(2))
                            {
                                case 0:
                                    ...
                                    {
                                        ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSpell, Database.WHITE_OUT);
                                    }
                                    break;
                                case 1:
                                    if (player.CurrentSkillPoint >= Database.ENIGMA_SENSE_COST)
                                    {
                                        ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSkill, Database.ENIGMA_SENSE);
                                    }
                                    break;
                            }
                        }
            ...
            else if (player.FirstName == Database.ENEMY_LAST_SINIKIA_KAHLHANZ)
            {
                if (player.CurrentInstantPoint >= player.MaxInstantPoint)
                {
                    if (player.BattleBarPos <= 250)
                    {
                        ...
                        else if ((GroundOne.P1.CurrentSigilOfHomura <= 0) && (player.CurrentMana >= Database.SIGIL_OF_HOMURA_COST))
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSpell, Database.SIGIL_OF_HOMURA);
                        }
                        ...
                        //else if ((GroundOne.P1.CurrentEnrageBlast <= 0) && (player.CurrentMana >= Database.ENRAGE_BLAST_COST))
                        //{
                        //    ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSpell, Database.ENRAGE_BLAST);
                        //}
            ...
            else if (player.FirstName == Database.ENEMY_LAST_OL_LANDIS)
            {
                if (player.CurrentInstantPoint >= player.MaxInstantPoint)
                {
                    ...
                    else
                    {
                        ...
                        else if ((player.CurrentLife < player.MaxLife / 2) && (GroundOne.P1.CurrentParalyze <= 0) && ((TruthEnemyCharacter)player).DetectCannotBeParalyze == false && player.CurrentSkillPoint >= Database.SURPRISE_ATTACK_COST)
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSkill, Database.SURPRISE_ATTACK);
                        }
                        else if ((player.CurrentLife < player.MaxLife / 2) && (player.CurrentMana >= Database.CELESTIAL_NOVA_COST))
                        {
                            ExecActionMethod(player, player, MainCharacter.PlayerAction.UseSpell, Database.CELESTIAL_NOVA);
                                 ...
                                 ((GroundOne.P1.CurrentSaintPower > 0) || (GroundOne.P1.CurrentHeatBoost > 0) || (GroundOne.P1.CurrentFlameAura > 0) || (GroundOne.P1.CurrentHolyBreaker > 0)))
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSpell, Database.DISPEL_MAGIC);
                        }
                        else if ((player.CurrentMana >= Database.TRANQUILITY_COST) &&
                                ((GroundOne.P1.CurrentGaleWind > 0) || (GroundOne.P1.CurrentWordOfFortune > 0)))
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSpell, Database.TRANQUILITY);
                        }
                        ...
                        else if ((GroundOne.P1.CurrentImpulseHitValue < 2) && ((player.CurrentBlackContract > 0) || (player.CurrentSkillPoint >= Database.IMPULSE_HIT_COST)))
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSkill, Database.IMPULSE_HIT);
                        }
                        else if ((GroundOne.P1.CurrentOnslaughtHitValue < 2) && ((player.CurrentBlackContract > 0) || (player.CurrentSkillPoint >= Database.ONSLAUGHT_HIT_COST)))
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSkill, Database.ONSLAUGHT_HIT);
                        }
                        else if ((GroundOne.P1.CurrentConcussiveHitValue < 2) && ((player.CurrentBlackContract > 0) || (player.CurrentSkillPoint >= Database.ONSLAUGHT_HIT_COST)))
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSkill, Database.CONCUSSIVE_HIT);
                        }
                    }
                }
            }
            ...
            else if (player.FirstName == Database.ENEMY_LAST_VERZE_ARTIE)
            {
                if (player.CurrentInstantPoint >= player.MaxInstantPoint)
                {
                    ...
                    else if (((TruthEnemyCharacter)player).AI_TacticsNumber == 9)
                    {
                        ...
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSpell, Database.GENESIS);
                        }
                    }
                }
            }
            ...
            else if (player.FirstName == Database.ENEMY_LAST_SIN_VERZE_ARTIE)
            {
                if (player.CurrentSpecialInstant >= player.MaxSpecialInstant)
                {
                    ...
                    if (player.CurrentLifeCountValue == 3)
                    {
                        ...
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.SpecialSkill, Database.FINAL_INVISIBLE_HUNDRED_CUTTER);
                        }
                    }
                    ...
                    {
                        ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.SpecialSkill, Database.FINAL_ZERO_INNOCENT_SIN);
                    }
                    else if (player.CurrentLifeCountValue <= 0)
                    {
                        if (player.CurrentLife <= player.MaxLife * 0.5f)
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.SpecialSkill, Database.FINAL_SEFINE_PAINFUL_HYMNUS);
                        }
                        else
                        {
                            ExecActionMethod(player, player, MainCharacter.PlayerAction.SpecialSkill, Database.FINAL_LADARYNTE_CHAOTIC_SCHEMA);
                ...
                else if (player.CurrentInstantPoint >= player.MaxInstantPoint)
                {
                    ...
                    else if (320 < player.BattleBarPos && player.BattleBarPos <= 350 && AP.Math.RandomInteger(40) == 0)
                    {
                        ...
                        {
                            ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.UseSpell, Database.WARP_GATE);
                        }
                    }
                }
                     ...
                     player.FirstName == Database.ENEMY_DRAGON_ALAKH_VES_T_ETULA)
            {
                if (((TruthEnemyCharacter)player).AI_TacticsNumber == 5)
                {
                    ...
                    ExecActionMethod(player, GroundOne.P1, MainCharacter.PlayerAction.SpecialSkill, "形成消失");
                }
            }
            #endregion
            ...
            else if (player.FirstName == Database.ENEMY_BOSS_BYSTANDER_EMPTINESS)
            {
                ...
                if (player.CurrentInstantPoint >= player.MaxInstantPoint)
                {
                    ...
                    if (rand == 0) { player.StackTarget = current.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3); player.StackCommandString = "キル・スピニングランサー"; }
        ...
        private void UpdatePlayerTarget(MainCharacter player)
        {
            if (player == ec1 || player == ec2 || player == ec3)
            {
                ...
                else if (GroundOne.WE.AvailableSecondCharacter == true && GroundOne.WE.AvailableThirdCharacter == false)
                {
                    ...
                    if (GroundOne.P1 != null && GroundOne.P1.Dead) player.Target = GroundOne.P2;
                    else if (GroundOne.P2 != null & GroundOne.P2.Dead) player.Target = GroundOne.P1;
                }
                else
                {
            ...
            for (int ii = 0; ii < ActiveList.Count; ii++)
            {
                ...
                if (ActiveList[ii].FirstName == Database.ENEMY_BOSS_BYSTANDER_EMPTINESS)
                {
                    ...
                    if (this.FieldBuff[0].AbstractCountDownBuff())
                    {
                        ...
                        if (player.Pattern1 > 0) { player.ActionCommandStackList.Add(Database.BLAZING_FIELD); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        if (player.Pattern1 > 1) { player.ActionCommandStackList.Add(Database.SIGIL_OF_HOMURA); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        if (player.Pattern1 > 2) { player.ActionCommandStackList.Add(Database.IMMOLATE); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        if (player.Pattern1 > 3) { player.ActionCommandStackList.Add(Database.WORD_OF_MALICE); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        if (player.Pattern1 > 4) { player.ActionCommandStackList.Add(Database.PIERCING_FLAME); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        if (player.Pattern1 > 5) { player.ActionCommandStackList.Add(Database.DEMONIC_IGNITE); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        if (player.Pattern1 > 6) { player.ActionCommandStackList.Add(Database.DOOM_BLADE); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        if (player.Pattern1 > 7) { player.ActionCommandStackList.Add(Database.LAVA_ANNIHILATION); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                    ...
                    if (this.FieldBuff[1].AbstractCountDownBuff())
                    {
                        ...
                        if (player.Pattern2 > 0) { player.ActionCommandStackList.Add(Database.ABSOLUTE_ZERO); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        if (player.Pattern2 > 0) { player.ActionCommandStackList.Add(Database.DAMNATION); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        if (player.Pattern2 > 1) { player.ActionCommandStackList.Add(Database.AUSTERITY_MATRIX); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        if (player.Pattern2 > 2) { player.ActionCommandStackList.Add(Database.BLACK_CONTRACT); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        if (player.Pattern2 > 3) { player.ActionCommandStackList.Add(Database.TRANQUILITY); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        if (player.Pattern2 > 4) { player.ActionCommandStackList.Add(Database.HYMN_CONTRACT); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        if (player.Pattern2 > 5) { player.ActionCommandStackList.Add(Database.DISPEL_MAGIC); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        if (player.Pattern2 > 6) { player.ActionCommandStackList.Add(Database.TRANSCENDENT_WISH); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                    ...
                    if (this.FieldBuff[3].AbstractCountDownBuff())
                    {
                        ...
                        if (player.Pattern4 <= 2) { player.ActionCommandStackList.Add(Database.STRAIGHT_SMASH); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        else if (player.Pattern4 <= 4) { player.ActionCommandStackList.Add(Database.DOUBLE_SLASH); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        else if (player.Pattern4 <= 8) { player.ActionCommandStackList.Add(Database.SILENT_RUSH); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        else if (player.Pattern4 <= 16) { player.ActionCommandStackList.Add(Database.CARNAGE_RUSH); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
                        else if (player.Pattern4 <= 32) { player.ActionCommandStackList.Add(Database.SOUL_EXECUTION); player.ActionCommandStackTarget.Add(player.Targetting(GroundOne.P1, GroundOne.P2, GroundOne.P3)); }
        ...
        public void UseItem_Click(Text sender)
        {
            ...
            {
                if (GroundOne.P1.Dead == false)
                {
                    UpdateBattleText(GroundOne.P1.GetCharacterSentence(125));
                }
                else if (GroundOne.WE.AvailableSecondCharacter && GroundOne.P2.Dead == false)
                {
                    UpdateBattleText(GroundOne.P2.GetCharacterSentence(125));
                }
                else if (GroundOne.WE.AvailableThirdCharacter && GroundOne.P3.Dead == false)
                {
                    UpdateBattleText(GroundOne.P3.GetCharacterSentence(125));
                }
                return;
            }
        ...
        public void RunAwayButton_Click()
        {
            ...
            //if (GroundOne.P1.CurrentStunning > 0 || GroundOne.P1.CurrentFrozen > 0 || GroundOne.P1.CurrentParalyze > 0)
            //{
            ...
            // debug
            //if (((GroundOne.P1.Level - this.ec1.Level <= -5) && AP.Math.RandomInteger(100) < 95) ||
            //    ((GroundOne.P1.Level - this.ec1.Level == -4) && AP.Math.RandomInteger(100) < 90) ||
            //    ((GroundOne.P1.Level - this.ec1.Level == -3) && AP.Math.RandomInteger(100) < 80) ||
            //    ((GroundOne.P1.Level - this.ec1.Level == -2) && AP.Math.RandomInteger(100) < 70) ||
            //    ((GroundOne.P1.Level - this.ec1.Level == -1) && AP.Math.RandomInteger(100) < 70) ||
            //    ((GroundOne.P1.Level - this.ec1.Level == 0) && AP.Math.RandomInteger(100) < 50) ||
            //    ((GroundOne.P1.Level - this.ec1.Level == 1) && AP.Math.RandomInteger(100) < 40) ||
            //    ((GroundOne.P1.Level - this.ec1.Level == 2) && AP.Math.RandomInteger(100) < 30) ||
            //    ((GroundOne.P1.Level - this.ec1.Level == 3) && AP.Math.RandomInteger(100) < 20) ||
            //    ((GroundOne.P1.Level - this.ec1.Level == 4) && AP.Math.RandomInteger(100) < 10) ||
            //    ((GroundOne.P1.Level - this.ec1.Level >= 5) && AP.Math.RandomInteger(100) < 5)
            //    )
            //{
        ...
        private void BattleEndPhase()
        {
            ...
            else
            {
                ...
                if (ec1.FirstName == Database.ENEMY_BOSS_LEGIN_ARZE_3 && GroundOne.P1.Dead)
                {
                    GroundOne.P1.ResurrectPlayer(1);
                }
                //System.Threading.Thread.Sleep(100);
                ...
                if (GroundOne.P1 != null)
                {
                    if ((GroundOne.P1.MainWeapon != null) && (GroundOne.P1.MainWeapon.Name == Database.POOR_PRACTICE_SWORD_ZERO) ||
                        (GroundOne.P1.SubWeapon != null) && (GroundOne.P1.SubWeapon.Name == Database.POOR_PRACTICE_SWORD_ZERO))
                    {
                ...
                if (GroundOne.DuelMode == false)
                {
                    ...
                    string targetItemName = Method.GetNewItem(Method.NewItemCategory.Battle, GroundOne.P1, ec1, GroundOne.WE.DungeonArea);
        ...
        private void GetExpAndGold()
        {
            if (GroundOne.WE.AvailableFirstCharacter)
            {
                ...
                if (GroundOne.P1 != null && GroundOne.P1.Level < Method.GetMaxLevel())
                {
                    GroundOne.P1.Exp += ec1.Exp;
                }
                GroundOne.P1.Gold += ec1.Gold;

                int levelUpPoint = 0;
                int cumultiveLvUpValue = 0;
                while (true)
                {
                    if (GroundOne.P1.Exp >= GroundOne.P1.NextLevelBorder && GroundOne.P1.Level < Method.GetMaxLevel())
                    {
                        levelUpPoint += GroundOne.P1.LevelUpPointTruth;
                        GroundOne.UpLifePointMC += GroundOne.P1.LevelUpLifeTruth;
                        GroundOne.P1.BaseLife += GroundOne.P1.LevelUpLifeTruth;
                        GroundOne.UpManaPointMC += GroundOne.P1.LevelUpManaTruth;
                        GroundOne.P1.BaseMana += GroundOne.P1.LevelUpManaTruth;
                        GroundOne.P1.Exp = GroundOne.P1.Exp - GroundOne.P1.NextLevelBorder;
                        GroundOne.P1.Level += 1;
                        cumultiveLvUpValue++;
                    }
                    else
                    {
            ...
            {
                // ダンジョン階層のクリア状況に応じてMAXレベル制限を設ける。
                if (GroundOne.P2 != null && GroundOne.P2.Level < Method.GetMaxLevel())
                {
                    GroundOne.P2.Exp += ec1.Exp;
                }
                ...
                while (true)
                {
                    if (GroundOne.P2.Exp >= GroundOne.P2.NextLevelBorder && GroundOne.P2.Level < Method.GetMaxLevel())
                    {
                        levelUpPoint += GroundOne.P2.LevelUpPointTruth;
                        GroundOne.UpLifePointSC += GroundOne.P2.LevelUpLifeTruth;
                        GroundOne.P2.BaseLife += GroundOne.P2.LevelUpLifeTruth;
                        GroundOne.UpManaPointSC += GroundOne.P2.LevelUpManaTruth;
                        GroundOne.P2.BaseMana += GroundOne.P2.LevelUpManaTruth;
                        GroundOne.P2.Exp = GroundOne.P2.Exp - GroundOne.P2.NextLevelBorder;
                        GroundOne.P2.Level += 1;
                        cumultiveLvUpValue++;
                    }
                    else
                    {
            ...
            {
                // ダンジョン階層のクリア状況に応じてMAXレベル制限を設ける。
                if (GroundOne.P3 != null && GroundOne.P3.Level < Method.GetMaxLevel())
                {
                    GroundOne.P3.Exp += ec1.Exp;
                }
                ...
                while (true)
                {
                    if (GroundOne.P3.Exp >= GroundOne.P3.NextLevelBorder && GroundOne.P3.Level < Method.GetMaxLevel())
                    {
                        levelUpPoint += GroundOne.P3.LevelUpPointTruth;
                        GroundOne.UpLifePointTC += GroundOne.P3.LevelUpLifeTruth;
                        GroundOne.P3.BaseLife += GroundOne.P3.LevelUpLifeTruth;
                        GroundOne.UpManaPointTC += GroundOne.P3.LevelUpManaTruth;
                        GroundOne.P3.BaseMana += GroundOne.P3.LevelUpManaTruth;
                        GroundOne.P3.Exp = GroundOne.P3.Exp - GroundOne.P3.NextLevelBorder;
                        GroundOne.P3.Level += 1;
                        cumultiveLvUpValue++;
                    }
                    else
                    {
