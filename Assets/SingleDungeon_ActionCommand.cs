...
namespace DungeonPlayer
{
    public partial class SingleDungeon : MotherForm
    {
        ...
        {
            if (GroundOne.WE.AvailableFirstCharacter && GroundOne.P1 != null && !GroundOne.P1.Dead) { group.Add(GroundOne.P1); }
            if (!GroundOne.DuelMode && GroundOne.WE.AvailableSecondCharacter && GroundOne.P2 != null && !GroundOne.P2.Dead) { group.Add(GroundOne.P2); }
            if (!GroundOne.DuelMode && GroundOne.WE.AvailableThirdCharacter && GroundOne.P3 != null && !GroundOne.P3.Dead) { group.Add(GroundOne.P3); }
        }
    }
}
