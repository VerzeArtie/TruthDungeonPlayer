...
namespace DungeonPlayer
{
    public partial class SingleDungeon : MotherForm
    {
                        ...
                        switch (player.FirstName)
                        {
                            ...
                            case Database.ENEMY_WONDER_SEED:
                                if (player.ActionLabel.text == "棘殻ローリング")
                                {
                                    ...
                                    {
                                        PlayerNormalAttack(player, GroundOne.P1, 0, false, true);
                                        System.Threading.Thread.Sleep(100);
                                    }
                                    if (GroundOne.P2 != null)
                                    {
                                        if (GroundOne.P2.Dead == false)
                                        {
                                            PlayerNormalAttack(player, GroundOne.P2, 0, false, true);
                                            System.Threading.Thread.Sleep(100);
                                        }
                                    }
                                }
                            ...
                            case Database.ENEMY_SHOTGUN_HYUI:
                                ...
                                else if (player.ActionLabel.text == "ホウセンの種")
                                {
                                    ...
                                    if (GroundOne.P1.Dead == false)
                                    {
                                        if (PlayerNormalAttack(player, GroundOne.P1, 0, false, true))
                                        {
                                            NowSlow(player, GroundOne.P1, 2);
                                        }
                                        System.Threading.Thread.Sleep(100);
                                    }
                                    if (GroundOne.P2 != null)
                                    {
                                        if (GroundOne.P2.Dead == false)
                                        {
                                            if (PlayerNormalAttack(player, GroundOne.P2, 0, false, true))
                                            {
                                                NowSlow(player, GroundOne.P2, 2);
                                            }
                                            System.Threading.Thread.Sleep(100);
                                        }
                                    }
                            ...
                            case Database.ENEMY_BLOOD_MOSS:
                                ...
                                if (GroundOne.P2 != null && GroundOne.P2.Dead == false && GroundOne.P2.CurrentTemptation <= 0)
                                {
                                    NowTemptation(player, GroundOne.P2, 2);
                                }
                                else if (GroundOne.P1 != null && GroundOne.P1.Dead == false && GroundOne.P1.CurrentTemptation <= 0)
                                {
                                    NowTemptation(player, GroundOne.P1, 2);
                                }
                                else
                                {
                                    NowTemptation(player, GroundOne.P1, 2);
                            ...
                            case Database.ENEMY_BOSS_KARAMITUKU_FLANSIS:
                                ...
                                else if (player.ActionLabel.text == "黒の毒胞子")
                                {
                                    ...
                                    if (GroundOne.P1.Dead == false)
                                    {
                                        NowPoison(player, GroundOne.P1, Database.INFINITY, true);
                                        NowBlind(player, GroundOne.P1, 4);
                                    }
                                    if (GroundOne.P2 != null)
                                    {
                                        if (GroundOne.P2.Dead == false)
                                        {
                                            NowPoison(player, GroundOne.P2, Database.INFINITY, true);
                                            NowBlind(player, GroundOne.P2, 4);
                                        }
                                    }
                                         ...
                                         (player.ActionLabel.text == "ファイアビューネ"))
                                {
                                    ...
                                    for (int ii = 0; ii < 10; ii++)
                                    {
                                        ...
                                        if (tempRandom == 0)
                                        {
                                            if (GroundOne.P1.Dead == false)
                                            {
                                                AbstractMagicDamage(player, GroundOne.P1, 10, ref damage, 0, "FireBall", 120, TruthActionCommand.MagicType.Fire, false, CriticalType.Random);
                                            }
                                            else
                                            {
                                                AbstractMagicDamage(player, GroundOne.P2, 10, ref damage, 0, "FireBall", 120, TruthActionCommand.MagicType.Fire, false, CriticalType.Random);
                                            }
                                        }
                                        else
                                        {
                            ...
                            case Database.ENEMY_ROLLING_MAGURO:
                                ...
                                {
                                    if (GroundOne.P2 != null && !GroundOne.P2.Dead)
                                    {
                                        UpdateBattleText(player.FirstName + "はローリング突進するターゲットに" + GroundOne.P2.FirstName + "を選んだ！\r\n");
                                        player.Target = GroundOne.P2;
                                    }
                                    else if (GroundOne.P3 != null && !GroundOne.P3.Dead)
                                    {
                                        UpdateBattleText(player.FirstName + "はローリング突進するターゲットに" + GroundOne.P3.FirstName + "を選んだ！\r\n");
                                        player.Target = GroundOne.P3;
                                    }
                                    else
                                    {
                                        UpdateBattleText(player.FirstName + "はローリング突進するターゲットに" + GroundOne.P1.FirstName + "を選んだ！\r\n");
                                        player.Target = GroundOne.P1;
                                    }
                                }
                            ...
                            case Database.ENEMY_GO_FLAME_SLASHER:
                                ...
                                else if (player.ActionLabel.text == "禍の炎")
                                {
                                    ...
                                    List<MainCharacter> group = new List<MainCharacter>();
                                    //if (GroundOne.P1 != null && !GroundOne.P1.Dead && GroundOne.P1.CurrentFireDamage2 <= 0) { group.Add(GroundOne.P1); }
                                    //if (GroundOne.P2 != null && !GroundOne.P2.Dead && GroundOne.P2.CurrentFireDamage2 <= 0) { group.Add(GroundOne.P2); }
                                    //if (GroundOne.P3 != null && !GroundOne.P3.Dead && GroundOne.P3.CurrentFireDamage2 <= 0) { group.Add(GroundOne.P3); }
                                    SetupAllyGroup(ref group);
                                    MainCharacter current = group[AP.Math.RandomInteger(group.Count - 1)];
        ...
        protected void PlayerAllBlind(MainCharacter player)
        {
            ...
            {
                NowBlind(player, GroundOne.P1, 2);
            }

            if (GroundOne.P2 != null && !GroundOne.P2.Dead)
            {
                NowBlind(player, GroundOne.P2, 2);
            }

            if (GroundOne.P3 != null && !GroundOne.P3.Dead)
            {
                NowBlind(player, GroundOne.P3, 2);
            }
        }
        ...
        protected void PlayerAllSilence(MainCharacter player)
        {
            if (GroundOne.P1 != null && !GroundOne.P1.Dead)
            {
                NowSilence(player, GroundOne.P1, 1);
            }

            if (GroundOne.P2 != null && !GroundOne.P2.Dead)
            {
                NowSilence(player, GroundOne.P2, 1);
            }

            if (GroundOne.P3 != null && !GroundOne.P3.Dead)
            {
                NowSilence(player, GroundOne.P3, 1);
            }
        }
        ...
        protected void PlayerAllStun(MainCharacter player)
        {
            if (GroundOne.P1 != null && !GroundOne.P1.Dead)
            {
                NowStunning(player, GroundOne.P1, 1, false);
            }
            if (GroundOne.P2 != null && !GroundOne.P2.Dead)
            {
                NowStunning(player, GroundOne.P2, 1, false);
            }
            if (GroundOne.P3 != null && !GroundOne.P3.Dead)
            {
                NowStunning(player, GroundOne.P3, 1, false);
            }
        }
        ...
        protected void PlayerSlowAllEnemy(MainCharacter player, int effectValue)
        {
            if (GroundOne.P1 != null && !GroundOne.P1.Dead)
            {
                GroundOne.P1.CurrentSlow = effectValue;
                GroundOne.P1.ActivateBuff(GroundOne.P1.pbSlow, Database.BaseResourceFolder + "Slow", effectValue);
                UpdateBattleText(GroundOne.P1.FirstName + "は動きが鈍くなった。\r\n");
            }
            if (GroundOne.P2 != null && !GroundOne.P2.Dead)
            {
                GroundOne.P2.CurrentSlow = effectValue;
                GroundOne.P2.ActivateBuff(GroundOne.P2.pbSlow, Database.BaseResourceFolder + "Slow", effectValue);
                UpdateBattleText(GroundOne.P2.FirstName + "は動きが鈍くなった。\r\n");
            }
            if (GroundOne.P3 != null && !GroundOne.P3.Dead)
            {
                GroundOne.P3.CurrentSlow = effectValue;
                GroundOne.P3.ActivateBuff(GroundOne.P3.pbSlow, Database.BaseResourceFolder + "Slow", effectValue);
                UpdateBattleText(GroundOne.P3.FirstName + "は動きが鈍くなった。\r\n");
            }
        }
        ...
        protected void PlayerPhysicalAttackAllEnemy(MainCharacter player, double damage, string soundName)
        {
            if (GroundOne.P1 != null && !GroundOne.P1.Dead)
            {
                PlayerNormalAttack(player, GroundOne.P1, 0.0f, 0, false, false, damage, 0, String.Empty, -1, false, CriticalType.Random);
            }

            if (GroundOne.P2 != null && !GroundOne.P2.Dead)
            {
                PlayerNormalAttack(player, GroundOne.P2, 0.0f, 0, false, false, damage, 0, String.Empty, -1, false, CriticalType.Random);
            }

            if (GroundOne.P3 != null && !GroundOne.P3.Dead)
            {
                PlayerNormalAttack(player, GroundOne.P3, 0.0f, 0, false, false, damage, 0, String.Empty, -1, false, CriticalType.Random);
            }
        }
        ...
        protected void PlayerMagicAttackAllEnemy(MainCharacter player, double damage, string soundName, TruthActionCommand.MagicType type)
        {
            if (GroundOne.P1 != null && !GroundOne.P1.Dead)
            {
                AbstractMagicDamage(player, GroundOne.P1, 0, damage, 0, soundName, 120, type, false, CriticalType.Random);
            }

            if (GroundOne.P2 != null && !GroundOne.P2.Dead)
            {
                AbstractMagicDamage(player, GroundOne.P2, 0, damage, 0, soundName, 120, type, false, CriticalType.Random);
            }

            if (GroundOne.P3 != null && !GroundOne.P3.Dead)
            {
                AbstractMagicDamage(player, GroundOne.P3, 0, damage, 0, soundName, 120, type, false, CriticalType.Random);
            }
        }
    }
}
